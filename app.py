...
# "verify_url": OPTIONAL. If the issuer has a public verification page for this
# credential (Credly, Coursera "Verify Certificate", Google Cloud Skills Boost,
# LinkedIn Learning, a hackathon results page, etc.), paste that link here and
# the "Verify Achievement" button will open it in a new tab. Leave it as None
# and a best-effort verification search is used instead.
ACHIEVEMENTS = [
    {
    ...
    },
    {
        ...
        "verify_url": None,  # e.g. "https://www.theforage.com/simulations/verify/..."
    },
    {
        ...
        "verify_url": None,  # e.g. "https://www.kaggle.com/competitions/.../leaderboard"
    },
]
